...
public final class BaseUserApp {
    ...
    public static void main(final String[] args) {
        ...
        if (AuthzRegistry.authorizationService().isAuthenticatedUserAuthorizedTo(BaseRoles.COLABORADOR)) {
            AplicacaoPortalController appController = new AplicacaoPortalController();
            appController.stopConnection();
        }
        System.exit(0);
    }
}
